...
def simulate_AdEx_network(
    ...
    phase_monitor = StateMonitor(network, ["v","w"], record=idx_monitored_neurons)
    ...
    return rate_monitor, spike_monitor, trace_monitor, phase_monitor, idx_monitored_neurons
