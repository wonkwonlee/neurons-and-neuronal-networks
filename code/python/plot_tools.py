...
def plot_network_activity(rate_monitor, spike_monitor, voltage_monitor=None, spike_train_idx_list=None,
    ...
    Args:
        rate_monitor (PopulationRateMonitor): rate of the populati   on
    ...
    if voltage_monitor is None:
        ...
        fig, (ax_raster, ax_voltage) = plt.subplots(2, 1, sharex=True, figsize=figure_size)
    ...
    return fig, ax_raster, ax_voltage
